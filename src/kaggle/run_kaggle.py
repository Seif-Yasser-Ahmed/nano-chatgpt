...
def run(manual_seed=1337,out_dir='out-gpt2',total_batch_size=524288,B=16,T=1024,max_lr=6e-4,min_lr=None,min_lr_factor=0.1,warmup_steps=71,max_steps=1907,eval_interval=250,eval_iters=20):
    ...
    for step in range(max_steps):
        ...
        if step % eval_interval == 0 or step == max_steps - 1:
            ...
            if master_process:
                ...
                checkpoint = {
                    'model': raw_model.state_dict(),      # Always save raw_model so you can load it without DDP later
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_dir", type=str, default="out-gpt2")
